...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div>
              <div style="margin-bottom: 100px;"><center><h1>Daftar Presensi Masuk Setelah Istirahat</h1></center></div>
              <div class="tablepresensimasuksetelahistirahat">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.tablepresensimasuksetelahistirahat').load("tampildaftarpresensimasuksetelahistirahat.php");
